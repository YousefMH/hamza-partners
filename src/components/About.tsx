        ...
        >
          <div>
            ...
            <motion.p variants={fadeUp} className="lede">
              منذ عام {siteConfig.foundedYear}، ترسّخ {siteConfig.firmNameAr} كشريك قانوني
              عريق في مصر — نقدّم خدمات قانونية رفيعة المستوى للشركات والمستثمرين والمؤسسات
              والأفراد. نجمع بين عمق الإرث المهني والمنظور التجاري لنصوغ حلولًا دقيقة تحمي
              المصالح وتفتح آفاق النمو في أسواق متغيرة.
            </motion.p>
          </div>
